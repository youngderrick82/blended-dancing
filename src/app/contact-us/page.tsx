    ...
    return (
        <div className="font-poppins">
            ...
            <div className="mb-12">
                ...
                <div className="text-center border-2 border-black lg:w-1/2 lg:m-auto">
                    <h2 className="font-playfairDisplay text-4xl text-center text-[#fad9d5] font-bold bg-black p-8">Additional Services</h2>
                    <div>
