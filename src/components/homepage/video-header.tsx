    ...
    return (
        <div>
            <div className="relative h-screen overflow-hidden">
                <div className="m-auto md:mt-40 sm:top-40 sm:w-4/5 z-10">
                    <Image
                    ...
                    />
                    <p className="text-lg text-gray-300 mt-2 absolute top-0 hidden">
                        Empowering dancers to evolve together through creativity
                        and passion.
                    </p>
                </div>

                <div className="relative right-0 top-0 md:mt-80 z-10 text-white text-center">
                ...
                <div className="w-1/3 m-auto flex justify-center items-center">
                    <Button className="mx-auto mt-36 md:hidden font-montserrat text-xl p-6 border-2 border-black bg-pink-500 hover:bg-pink-700 text-white transition-transform transform hover:scale-110">
                        <Link href="https://dancestudio-pro.com/online/index.php?account_id=31613" target="_blank">
                            Join Us Today
                            <span>&#8594;</span>
                        </Link>
                    </Button>
